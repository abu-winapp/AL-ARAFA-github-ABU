...
export default function OrderTrackingPage() {
  ...
  const { fetchAllSettings, getGSTRate, isGSTEnabled, getPointsPerDollar } =
    useSettingsStore();
  ...
  const handleRepay = async () => {
    ...
    try {
      ...
      let paymentUrl: string | null =
        paymentResponse.payment?.paymentUrl ||
      ...
      if (!paymentUrl && paymentResponse.payment) {
        const dataString =
          ...
          (paymentResponse.payment as any).gatewayResponse;
        if (dataString) {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
              {hasPaymentError ? (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Your order was created but payment initiation failed. Please
                ...
                <Alert className="border-yellow-300 bg-yellow-50">
                  ...
                  <AlertDescription className="text-yellow-700">
                    Your payment is being processed. This page will
                    automatically update when the payment is confirmed (usually
                    within 30 seconds).
                  </AlertDescription>
                </Alert>
              )}
          ...
          {order.fulfillmentType === "delivery" && delivery && !isCancelled && (
            <div className="bg-[white] from-primary to-primary-dark text-[black] rounded-2xl shadow-xl p-8 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              ...
              {(order.pointsDiscount ?? 0) > 0 && (
                <div className="flex justify-between text-success">
                  ...
                  <span className="font-semibold">
                    - S$ {(order.pointsDiscount ?? 0).toFixed(2)}
                  </span>
                </div>
              )}
            ...
            {(order.status === "delivered" ||
              ...
              (order.pointsEarned ||
                (order.subtotal > 0 && getPointsPerDollar() > 0)) && (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-green-800">
                        +
                        {order.pointsEarned ||
                          Math.floor(order.subtotal * getPointsPerDollar())}
                      </div>
