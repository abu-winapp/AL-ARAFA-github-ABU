    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-background-gray pt-12 pb-12 md:pt-0">
      <div className="mx-auto w-full max-w-full px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Filter Tabs */}
          <div className="grid grid-cols-3 gap-2 mb-8 sm:flex sm:gap-3">
            <button
              onClick={() => setFilter("all")}
              className={clsx(
                "w-full min-w-0 px-3 py-2.5 rounded-lg font-semibold transition-all sm:w-auto sm:px-6",
                filter === "all"
              ...
              <div className="space-y-5 sm:space-y-6">
                {filteredOrders.map((order) => {
                  ...
                  const getOrderTypeBadge = () => {
                    if (order.instantOrder || order.orderType === "instant")
                      return "Instant";
                    if (order.cateringOrder || order.orderType === "catering")
                      return "Catering";
                        ...
                        <div className="mb-4 flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          <div className="min-w-0 flex-1">
                            <div className="mb-1 flex min-w-0 flex-wrap items-center gap-2">
                              <h3 className="min-w-0 break-words font-bold text-text-primary text-base sm:text-lg">
